...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        spacerItem2 = QtWidgets.QSpacerItem(
            20, 67, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding
        )
    ...
    def retranslateUi(self, Form):
        ...
        self.groupBox.setTitle(
            _translate("Form", "Source inputs Used to Create the Dataset")
        )
        ...
        self.radio_sourceyes.setText(
            _translate(
                "Form",
                "The source inputs are described below (reference imagery/material, assorted GIS inputs, etc.)",
            )
        )

...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.fgdc_progress.setGeometry(QtCore.QRect(30, 80, 181, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(9)
        ...
        self.fgdc_progress.addItem("")
        self.fgdc_progress.addItem("")
        self.label = QtWidgets.QLabel(self.fgdc_status)

...
"}")
        ...
        spacerItem2 = QtWidgets.QSpacerItem(10, 29, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_search_term_4.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_search_term.sizePolicy().hasHeightForWidth())
        ...
        spacerItem3 = QtWidgets.QSpacerItem(24, 10, QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Minimum)
        ...
        self.place.setStyleSheet("QTreeView:item:has-children {\n"
"\n"
"color: rgb(90, 90, 190);\n"
"}\n"
"\n"
...
"}")
    ...
    def retranslateUi(self, place_keywords):
        ...
        self.fgdc_place.setTitle(_translate("place_keywords", "Place Keywords (Grouped by Thesaurus):  "))
        ...
        self.groupBox_2.setTitle(_translate("place_keywords", "Tools for adding Place Keywords:"))
        ...
        self.btn_search_controlled.setToolTip(_translate("place_keywords", "Perform search of USGS Controlled Vocabularies"))
        self.btn_search_controlled.setText(_translate("place_keywords", "Search Controlled Vocabularies"))
        self.label_search_term_4.setText(_translate("place_keywords", "Place Keyword Thesaurus:"))
        self.placekt.setToolTip(_translate("place_keywords", "terms to search ITIS for"))
        self.placekt.setText(_translate("place_keywords", "None"))
        self.label_search_term.setText(_translate("place_keywords", "Add Free-Text Place Keyword:"))
        self.placekey.setToolTip(_translate("place_keywords", "terms to search ITIS for"))
        self.btn_add_custom.setToolTip(_translate("place_keywords", "Add Custom Keyword"))
        self.btn_add_custom.setText(_translate("place_keywords", "Add Custom Keyword"))
        self.btn_remove_keywords.setText(_translate("place_keywords", "Remove Selected Keywords"))

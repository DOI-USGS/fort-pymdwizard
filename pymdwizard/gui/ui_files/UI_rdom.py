...
class Ui_fgdc_rdom(object):
    def setupUi(self, fgdc_rdom):
        ...
        self.label_26 = QtWidgets.QLabel(fgdc_rdom)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"Domain: free text\n"
"Short Name: address"))
        self.label_26.setToolTip(_translate("fgdc_rdom", "Required"))
        self.label_26.setText(_translate("fgdc_rdom", "<html><head/><body><p align=\"center\"><span style=\" font-size:18pt; color:#55aaff;\">*</span></p></body></html>"))

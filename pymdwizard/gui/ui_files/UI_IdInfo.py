...
class Ui_fgdc_idinfo(object):
    def setupUi(self, fgdc_idinfo):
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.two_column_left.sizePolicy().hasHeightForWidth())
        ...
        self.fgdc_crossref = QtWidgets.QWidget(self.idinfo_main_widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.fgdc_crossref.sizePolicy().hasHeightForWidth())
        self.fgdc_crossref.setSizePolicy(sizePolicy)
        self.fgdc_crossref.setObjectName("fgdc_crossref")
        self.verticalLayout_8 = QtWidgets.QVBoxLayout(self.fgdc_crossref)
        ...
        self.verticalLayout_2.addWidget(self.fgdc_crossref)

...
class Ui_fgdc_citation(object):
    def setupUi(self, fgdc_citation):
        ...
        self.help_title = QtWidgets.QGroupBox(self.fgdc_citeinfo)
        ...
        self.help_pubdate = QtWidgets.QGroupBox(self.fgdc_citeinfo)
        ...
        self.help_origin = QtWidgets.QGroupBox(self.fgdc_citeinfo)
        ...
        self.help_geoform = QtWidgets.QGroupBox(self.fgdc_citeinfo)
        ...
        self.help_onlink = QtWidgets.QGroupBox(self.fgdc_citeinfo)
    ...
    def retranslateUi(self, fgdc_citation):
        ...
        self.help_title.setTitle(_translate("fgdc_citation", "Dataset Title"))
        ...
        self.label_5.setToolTip(_translate("fgdc_citation", "Required"))
        self.label_5.setText(_translate("fgdc_citation", "<html><head/><body><p><span style=\" font-size:18pt; color:#55aaff;\">*</span></p></body></html>"))
        self.help_pubdate.setTitle(_translate("fgdc_citation", "Publication Date "))
        self.label_38.setText(_translate("fgdc_citation", "When was the data set published or finalized?"))
        self.help_origin.setTitle(_translate("fgdc_citation", "Dataset Author/ Originator"))
        self.label_35.setText(_translate("fgdc_citation", "Who created the data set? List the organization and/or person(s)"))
        self.help_geoform.setTitle(_translate("fgdc_citation", "Dataset Format"))
        ...
        self.label_8.setToolTip(_translate("fgdc_citation", "Required"))
        self.label_8.setText(_translate("fgdc_citation", "<html><head/><body><p><span style=\" font-size:18pt; color:#55aaff;\">*</span></p></body></html>"))
        self.help_onlink.setTitle(_translate("fgdc_citation", "Online Link to the Dataset"))
        ...
        self.help_sername.setText(_translate("fgdc_citation", "Series Name"))
        self.label_6.setToolTip(_translate("fgdc_citation", "Required"))
        self.label_6.setText(_translate("fgdc_citation", "<html><head/><body><p><span style=\" font-size:18pt; color:#55aaff;\">*</span></p></body></html>"))
        self.help_issue.setText(_translate("fgdc_citation", "Issue Name / Number within Series"))
        self.label_7.setToolTip(_translate("fgdc_citation", "Required"))
        self.label_7.setText(_translate("fgdc_citation", "<html><head/><body><p><span style=\" font-size:18pt; color:#55aaff;\">*</span></p></body></html>"))
        ...
        self.help_pubplace.setText(_translate("fgdc_citation", "Publication Place"))
        self.label_3.setToolTip(_translate("fgdc_citation", "Required"))
        self.label_3.setText(_translate("fgdc_citation", "<html><head/><body><p><span style=\" font-size:18pt; color:#55aaff;\">*</span></p></body></html>"))
        self.help_publish.setText(_translate("fgdc_citation", "Publisher"))
        self.label_4.setToolTip(_translate("fgdc_citation", "Required"))
        self.label_4.setText(_translate("fgdc_citation", "<html><head/><body><p><span style=\" font-size:18pt; color:#55aaff;\">*</span></p></body></html>"))

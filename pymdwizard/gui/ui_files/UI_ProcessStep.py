...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.frame_proccont = QtWidgets.QFrame(self.fgdc_procstep)
        self.frame_proccont.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_proccont.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_proccont.setObjectName("frame_proccont")
        self.verticalLayout_6 = QtWidgets.QVBoxLayout(self.frame_proccont)
        self.verticalLayout_6.setObjectName("verticalLayout_6")
        self.verticalLayout_5.addWidget(self.frame_proccont)

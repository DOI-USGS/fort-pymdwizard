...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        spacerItem = QtWidgets.QSpacerItem(
            20, 0, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred
        )
        ...
        self.lbl_dataset_title_2.setAlignment(
            QtCore.Qt.AlignLeading | QtCore.Qt.AlignLeft | QtCore.Qt.AlignTop
        )
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(
            _translate("Form", "Describe the processing step or method below:")
        )

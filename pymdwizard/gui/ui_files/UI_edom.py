...
class Ui_fgdc_edom(object):
    def setupUi(self, fgdc_edom):
        ...
        self.fgdc_edomvd = QtWidgets.QLineEdit(self.frame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.fgdc_edomvd.sizePolicy().hasHeightForWidth())
        self.fgdc_edomvd.setSizePolicy(sizePolicy)
        self.fgdc_edomvd.setMinimumSize(QtCore.QSize(0, 0))
        self.fgdc_edomvd.setMaximumSize(QtCore.QSize(16777215, 20))
    ...
    def retranslateUi(self, fgdc_edom):
        ...
        self.label_19.setText(_translate("fgdc_edom", " Value (unique item in this column)"))
        self.fgdc_edomv.setToolTip(_translate("fgdc_edom", "Address -- an address line for the address.\n"
"Type: text\n"
"Domain: free text\n"
"Short Name: address"))
        self.label_20.setToolTip(_translate("fgdc_edom", "Required"))
        self.label_20.setText(_translate("fgdc_edom", "<html><head/><body><p align=\"center\"><span style=\" font-size:18pt; color:#55aaff;\">*</span></p></body></html>"))
        self.label_21.setText(_translate("fgdc_edom", "Definition of this Value"))
        self.fgdc_edomvd.setToolTip(_translate("fgdc_edom", "Address -- an address line for the address.\n"
"Type: text\n"
"Domain: free text\n"
"Short Name: address"))

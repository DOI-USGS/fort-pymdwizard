...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.growingtextedit = GrowingTextEdit(self.fgdc_descript)
        self.growingtextedit.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustToContents)
        self.growingtextedit.setObjectName("growingtextedit")
        self.verticalLayout_2.addWidget(self.growingtextedit)

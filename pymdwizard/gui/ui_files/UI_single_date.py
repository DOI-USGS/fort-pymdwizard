...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.frame_format = QtWidgets.QFrame(Form)
        self.frame_format.setObjectName("frame_format")
        self.layout_format = QtWidgets.QHBoxLayout(self.frame_format)
        self.layout_format.setContentsMargins(0, 0, 6, -1)
        ...
        self.lbl_format = QtWidgets.QLabel(self.frame_format)
        ...
        self.verticalLayout.addWidget(self.frame_format)

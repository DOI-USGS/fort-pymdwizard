...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.lbl_cntper = QtWidgets.QLabel(self.widget)
        ...
        self.verticalLayout_2.addWidget(self.lbl_cntper)
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.fgdc_descgeog = QtWidgets.QLineEdit(self.widget)
        ...
        self.map_display.setMinimumSize(QtCore.QSize(400, 0))
    ...
    def retranslateUi(self, Form):
        ...
        self.lbl_cntper.setToolTip(_translate("Form", "The name of the person to contact"))
        self.lbl_cntper.setText(_translate("Form", "Description of Geographic Extent"))
...
"Domain: free text\n"
"Short Name: cntper"))
        self.label_3.setToolTip(_translate("Form", "Required"))
        self.label_3.setText(_translate("Form", "<html><head/><body><p><span style=\" font-size:18pt; color:#55aaff;\">*</span></p></body></html>"))

...
class Ui_fgdc_spdom(object):
    ...
    def retranslateUi(self, fgdc_spdom):
        ...
        self.descgeog_label.setToolTip(_translate("fgdc_spdom", "The name of the person to contact"))
        self.descgeog_label.setText(_translate("fgdc_spdom", "Description of Geographic Extent"))
        self.descgeog_star.setToolTip(_translate("fgdc_spdom", "Required"))
        self.descgeog_star.setText(_translate("fgdc_spdom", "<html><head/><body><p><span style=\" font-size:18pt; color:#55aaff;\">*</span></p></body></html>"))
        ...
        self.label_4.setText(_translate("fgdc_spdom", "<html><head/><body><p><span style=\" font-size:18pt; color:#55aaff;\">*</span></p></body></html>"))
        self.lbl_cntper_3.setText(_translate("fgdc_spdom", "East (-180 - 180)  "))
        self.label_5.setToolTip(_translate("fgdc_spdom", "Required"))
        self.label_5.setText(_translate("fgdc_spdom", "<html><head/><body><p><span style=\" font-size:18pt; color:#55aaff;\">*</span></p></body></html>"))
        self.lbl_cntper_4.setText(_translate("fgdc_spdom", "North (-90 - 90)     "))
        self.label_6.setToolTip(_translate("fgdc_spdom", "Required"))
        self.label_6.setText(_translate("fgdc_spdom", "<html><head/><body><p><span style=\" font-size:18pt; color:#55aaff;\">*</span></p></body></html>"))
        self.lbl_cntper_5.setText(_translate("fgdc_spdom", "South (-90 - 90)    "))
        self.label_7.setToolTip(_translate("fgdc_spdom", "Required"))
        self.label_7.setText(_translate("fgdc_spdom", "<html><head/><body><p><span style=\" font-size:18pt; color:#55aaff;\">*</span></p></body></html>"))

...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.btn_local = QtWidgets.QRadioButton(self.fgdc_horizsys)
        ...
        self.mapproj_contents = QtWidgets.QWidget(self.fgdc_mapproj)
        ...
        self.verticalLayout_7.addWidget(self.mapproj_contents)
        ...
        self.formLayout_8.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.label_16)
    ...
    def retranslateUi(self, Form):
        ...
        self.btn_local.setText(_translate("Form", "Local"))
        self.label.setText(_translate("Form", "Latitude Resolution"))
        self.fgdc_latres.setText(_translate("Form", "0.0001"))
        self.label_2.setText(_translate("Form", "Longitude Resolution"))
        self.fgdc_longres.setText(_translate("Form", "0.0001"))
        ...
        self.fgdc_geogunit.setItemText(0, _translate("Form", "Decimal degrees"))
        self.fgdc_geogunit.setItemText(1, _translate("Form", "Decimal minutes"))
        self.fgdc_geogunit.setItemText(2, _translate("Form", "Decimal seconds"))
        self.fgdc_geogunit.setItemText(3, _translate("Form", "Degrees and decimal minutes"))
        self.fgdc_geogunit.setItemText(4, _translate("Form", "Degrees, minutes, and decimal seconds"))
        self.fgdc_geogunit.setItemText(5, _translate("Form", "Radians"))
        self.fgdc_geogunit.setItemText(6, _translate("Form", "Grads"))
        self.btn_projection.setText(_translate("Form", "Map Projection"))
        self.btn_grid.setText(_translate("Form", "Grid Coordinate System"))
        self.btn_localp.setText(_translate("Form", "Local Planar"))
        ...
        self.groupBox.setTitle(_translate("Form", "Planar Coordinate Information"))
        self.label_15.setText(_translate("Form", "Planar Coordinate Encoding Method"))
        self.fgdc_plance.setItemText(0, _translate("Form", "coordinate pair"))
        self.fgdc_plance.setItemText(1, _translate("Form", "distance and bearing"))
        self.fgdc_plance.setItemText(2, _translate("Form", "row and column"))
        self.label_16.setText(_translate("Form", "Abscissa Resolution"))
        self.fgdc_absres.setText(_translate("Form", "0.0001"))
        self.label_17.setText(_translate("Form", "Ordinate Resolution"))
        self.fgdc_ordres.setText(_translate("Form", "0.0001"))
        self.label_18.setText(_translate("Form", "Grid System Name"))
        self.fgdc_plandu.setItemText(0, _translate("Form", "meters"))
        self.fgdc_plandu.setItemText(1, _translate("Form", "International feet"))
        self.fgdc_plandu.setItemText(2, _translate("Form", "survey feet"))
        self.label_12.setText(_translate("Form", "Local Description"))
        self.label_14.setText(_translate("Form", "Local Georeference Information"))
        self.fgdc_geodetic.setTitle(_translate("Form", "Datum (optional)"))
        self.label_8.setText(_translate("Form", "Datum Name"))
        self.fgdc_ellips.setItemText(0, _translate("Form", "Clarke 1866"))
        self.fgdc_ellips.setItemText(1, _translate("Form", "Geodetic Reference System 1980"))
        self.fgdc_ellips.setItemText(2, _translate("Form", "WGS_1984"))
        self.label_9.setText(_translate("Form", "Elipsoid Name"))
        self.label_10.setText(_translate("Form", "Semi-major Axis"))
        self.fgdc_semiaxis.setText(_translate("Form", "6378137.000000"))
        self.label_11.setText(_translate("Form", "Denominator Flattening Ratio"))
        self.fgdc_denflat.setText(_translate("Form", "298.257224"))
        self.fgdc_horizdn.setItemText(0, _translate("Form", "North American Datum of 1927 (NAD 27)"))
        self.fgdc_horizdn.setItemText(1, _translate("Form", "North American Datum of 1983 (NAD 83)"))
        self.fgdc_horizdn.setItemText(2, _translate("Form", "World Geodetic System 1984 (WGS 84)"))

...
class Ui_fgdc_metainfo(object):
    ...
    def retranslateUi(self, fgdc_metainfo):
        ...
        self.label_10.setText(_translate("fgdc_metainfo", "Select \'FGDC Biological Data Profile of the CSDGM\' if your data contains information about a species"))
        self.fgdc_metstdn.setCurrentText(_translate("fgdc_metainfo", "FGDC Biological Data Profile of the Content Standard for Digital Geospatial Metadata"))
        self.fgdc_metstdn.setItemText(0, _translate("fgdc_metainfo", "FGDC Content Standard for Digital Geospatial Metadata"))
        self.fgdc_metstdn.setItemText(1, _translate("fgdc_metainfo", "FGDC Biological Data Profile of the Content Standard for Digital Geospatial Metadata"))

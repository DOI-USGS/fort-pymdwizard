...
class Ui_fgdc_metainfo(object):
    ...
    def retranslateUi(self, fgdc_metainfo):
        ...
        self.fgdc_metstdn.setCurrentText(_translate("fgdc_metainfo", "FGDC Biological Data Profile of the CSDGM"))
        self.fgdc_metstdn.setItemText(0, _translate("fgdc_metainfo", "FGDC CSDGM"))
        self.fgdc_metstdn.setItemText(1, _translate("fgdc_metainfo", "FGDC Biological Data Profile of the CSDGM"))

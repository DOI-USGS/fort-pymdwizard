...
class Ui_fgdc_metainfo(object):
    def setupUi(self, fgdc_metainfo):
        ...
        self.frame = QtWidgets.QFrame(fgdc_metainfo)
        ...
        self.fgdc_metstdv = QtWidgets.QComboBox(self.groupBox_3)
        ...
        self.fgdc_metstdn = QtWidgets.QComboBox(self.groupBox)
        ...
        self.group_metd = QtWidgets.QGroupBox(self.two_column_right)
        self.group_metd.setObjectName("group_metd")
        self.verticalLayout_9 = QtWidgets.QVBoxLayout(self.group_metd)
        self.verticalLayout_9.setObjectName("verticalLayout_9")
        self.verticalLayout_4.addWidget(self.group_metd)
    ...
    def retranslateUi(self, fgdc_metainfo):
        ...
        self.groupBox_3.setTitle(_translate("fgdc_metainfo", "Metadata Standard Version"))
        ...
        self.groupBox.setTitle(_translate("fgdc_metainfo", "Metadata Standard Name"))
        ...
        self.group_metd.setTitle(_translate("fgdc_metainfo", "Metadata Date"))

...
class Ui_fgdc_metainfo(object):
    ...
    def retranslateUi(self, fgdc_metainfo):
        ...
        self.label_5.setText(
            _translate(
                "fgdc_metainfo",
                '<html><head/><body><p><span style=" font-style:italic; color:#55aaff;">Provide information about the individual who wrote the metadata for the dataset.  This is usually YOUR information</span></p><p><br/></p></body></html>',
            )
        )
        ...
        self.label_2.setText(
            _translate(
                "fgdc_metainfo",
                "Who wrote the metadata?  Alternatively, who can be contacted for questions pertaining to the metadata?",
            )
        )
        self.label_6.setText(
            _translate(
                "fgdc_metainfo",
                "Is the Metadata Contact the same as the Dataset Contact?",
            )
        )
        self.button_use_dataset.setText(
            _translate("fgdc_metainfo", "Use Dataset Contact Info")
        )
        self.help_metstdv.setTitle(
            _translate("fgdc_metainfo", "Metadata Standard Version")
        )
        self.label_9.setText(
            _translate(
                "fgdc_metainfo", "You probably won't have a need to change this value"
            )
        )
        self.fgdc_metstdv.setItemText(
            0, _translate("fgdc_metainfo", "FGDC-STD-001-1998")
        )
        self.fgdc_metstdv.setItemText(
            1, _translate("fgdc_metainfo", "FGDC-STD-001.1-1999")
        )
        ...
        self.help_metstdn.setTitle(
            _translate("fgdc_metainfo", "Metadata Standard Name")
        )
        self.label_10.setText(
            _translate(
                "fgdc_metainfo",
                "Select 'FGDC Biological Data Profile of the CSDGM' if your data contains information about a species",
            )
        )
        self.fgdc_metstdn.setCurrentText(
            _translate(
                "fgdc_metainfo",
                "FGDC Biological Data Profile of the Content Standard for Digital Geospatial Metadata",
            )
        )
        self.fgdc_metstdn.setItemText(
            0,
            _translate(
                "fgdc_metainfo", "FGDC Content Standard for Digital Geospatial Metadata"
            ),
        )
        self.fgdc_metstdn.setItemText(
            1,

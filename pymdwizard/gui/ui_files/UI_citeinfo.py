...
class Ui_parent_form(object):
    ...
    def retranslateUi(self, parent_form):
        ...
        self.label_45.setText(_translate("parent_form", "Dataset Title"))
        ...
        self.label_38.setText(_translate("parent_form", "When was the data set published or finalized?"))
        self.label_47.setText(_translate("parent_form", "Dataset Author/ Originator"))
        self.label_35.setText(_translate("parent_form", "Who created the data set? List the organization and/or person(s)"))
        ...
        self.label_43.setText(_translate("parent_form", "Is this data set part of a series?"))
        ...
        self.label_49.setText(_translate("parent_form", "Can you provide more publication information about this data set?"))
        ...
        self.label_66.setText(_translate("parent_form", "If the citation of a larger project is relevant, you may optionally cite it here."))

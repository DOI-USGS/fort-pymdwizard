    ...
    def to_xml(self):
        ...
        if self.ui.btn_geographic.isChecked():
            ...
            if self.ui.btn_projection.isChecked():
                ...
                root_node = xml_node(gridsys_info["shortname"], parent_node=gridsys)
            ...
            xml_node(
                "plance", text=self.ui.fgdc_plance.currentText(), parent_node=planci
            )
            coordrep = xml_node("coordrep", parent_node=planci)
            xml_node("absres", text=self.ui.fgdc_absres.text(), parent_node=coordrep)
            xml_node("ordres", text=self.ui.fgdc_ordres.text(), parent_node=coordrep)
            xml_node(
                "plandu", text=self.ui.fgdc_plandu.currentText(), parent_node=planci
            )
        else:
            local = xml_node("local", parent_node=horizsys)
            xml_node("localdes", text=self.ui.fgdc_localdes.text(), parent_node=local)
            xml_node("localgeo", text=self.ui.fgdc_localgeo.text(), parent_node=local)

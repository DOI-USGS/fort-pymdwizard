...
#                print "tag", element.tag
    ...
    def _to_xml(self):
        ...
        citation.text = self.findChild(QPlainTextEdit, "fgdc_title").toPlainText()
        #print "ok"
    ...
    def _from_xml(self, citation):
        ...
        try:
            if citation.tag == 'citation':
               accost_box = self.findChild(QPlainTextEdit, "fgdc_citation")
               accost_box.setPlainText(citation.text)
            else:

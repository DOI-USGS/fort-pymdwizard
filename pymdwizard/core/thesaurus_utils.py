...
# term. Excluded from search and validation until the service issue is resolved.
...
def find_invalid_keywords(thesaurus_name, keywords, lookup=None):
    ...
    # Skip thesauri whose web-service endpoints are known to be broken.
    if thcode in BROKEN_THESAURUS_THCODES:
        return []

...
contains default content which forms a solid starting point for a blank
new record. For example the point of contact, distribution contact,
...
specified in the template can be overwritten individual when edit a new
record, they are just the defaults that will pre-populate the
application.

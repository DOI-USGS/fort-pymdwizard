...
*Before submitting an issue please make sure your application is up to date by following the steps* here_.

.. _here: <Getting%20Software%20Updates.html>

If you encounter any problems while using the Metadata Wizard 2.0 or have ideas for how to improve the application, please submit them as issues directly to the GitHub repository’s `issues page

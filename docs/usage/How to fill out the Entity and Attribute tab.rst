...
This tools facilitates a robust Entity and Attribute generation by
...
MetadataWizard from the ArcToolbox.
...
Data in proprietary/complex format
----------------------------------
...
each observation forms a row, and each observational unit forms a table
    ...
    | 2) Range for numeric data, a min, max, and the units will be
      required
    ...
    | 4) Unrepresentable for every other case where you must provide a
      free text description of how to interpret the values in this
      column.
    | \*\*\*
...
several related CSVs or multiple sheets in an Excel workbook.
    ...
    Click the ‘Add Detailed‘ button below
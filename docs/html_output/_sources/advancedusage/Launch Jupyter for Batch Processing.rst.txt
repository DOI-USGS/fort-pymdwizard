...
A live instance of a Jupyter Notebook Kernel can be launch directly from the Metadata Wizard application by clicking **Launch Jupyter** in the **Advanced** menu.
...
The user will be asked where they would like to open Jupyter.  If you're just
getting started or want to take a look at the examples, choose the default directory.
If you're working on a project you can browse to a different directory.
...
above techniques to generate metadata for multiple datasets and move the associated
